...
private Double adicionalRapido;
    ...
    public Metralhadora(Double adicionalRapido, Double adicionalForca, Double adicionalEspecial, Boolean habilitada) {
    ...
    public String toString() {
        return "Metralhadora [adicionalRapido=" + adicionalRapido + ", adicionalForca=" + adicionalForca
