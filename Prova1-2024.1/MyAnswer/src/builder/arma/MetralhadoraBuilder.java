...
import model.arma.Metralhadora;
import model.interfaces.Arma;

public class MetralhadoraBuilder implements ArmaBuilder{
    ...
    @Override
    public Arma build() {
        return new Metralhadora(adicionalRapido, adicionalForca, adicionalEspecial, habilitada);
    }
}
